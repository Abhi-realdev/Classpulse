/*
  ...
  1. New Tables
    ...
    - `feedback`
      ...
      - `student_email` (text, student identifier)
      - `subject` (text, subject for which feedback is given)
      - `clarity_explanation` (integer, rating 1-5)
      - `simplification` (integer, rating 1-5)
      - `examples_analogies` (integer, rating 1-5)
      - `engagement` (integer, rating 1-5)
      - `pace_teaching` (integer, rating 1-5)
      - `depth_knowledge` (integer, rating 1-5)
      - `accuracy_info` (integer, rating 1-5)
      - `concept_reinforcement` (integer, rating 1-5)
      - `problem_solving` (integer, rating 1-5)
      - `clarity_instructions` (integer, rating 1-5)
      - `patience_approachability` (integer, rating 1-5)
      - `motivation_encouragement` (integer, rating 1-5)
      - `adaptability` (integer, rating 1-5)
      - `visual_aids` (integer, rating 1-5)
      - `technology_integration` (integer, rating 1-5)
      - `interactive_methods` (integer, rating 1-5)
      - `helping_understand` (integer, rating 1-5)
      - `critical_thinking` (integer, rating 1-5)
      - `homework_support` (integer, rating 1-5)
      - `openness_feedback` (integer, rating 1-5)
      - `comments` (text, optional student comments)
      - `created_at` (timestamp)

  2. Security
    - Enable RLS on all tables
    - Add policies for authenticated users to submit feedback
    - Add policies for teachers to view their own feedback
    - Add policies for public access to leaderboard data
*/
...
INSERT INTO teachers (name, subject, email, avatar_url) VALUES
  ...
  ,('Mr. Sandeep Mehta', 'Mathematics', 'sandeep.mehta@sunbeam.edu.in', ''),
  ('Ms. Pooja Rao', 'Physics', 'pooja.rao@sunbeam.edu.in', ''),
  ('Mr. Arjun Singh', 'Computer Science', 'arjun.singh@sunbeam.edu.in', ''),
  ('Ms. Meera Nair', 'English', 'meera.nair@sunbeam.edu.in', '')
